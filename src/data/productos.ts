...
export const PRODUCTS: Product[] = [
  ...
  silla('style-presidente', 'Silla Style', 'Sillas gerenciales', 'MCH-SLG-02', { cover: 4 }),
  ...
  silla('net', 'Silla Net', 'Colectividades', 'MCH-COL-10', { cover: 4 }),
  ...
  silla('glen', 'Silla Glen', 'Colectividades', 'MCH-COL-17', { cover: 1 }),
